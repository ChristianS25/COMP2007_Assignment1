<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Team4.aspx.cs" Inherits="CR_Assignment1.Team4" %>
    ...
    <asp:GridView runat="server" CssClass="table table-bordered table-striped table-hover"
                    ...
                    <Columns>
                        <asp:BoundField DataField="team_name" HeaderText="Team Name" Visible="true" SortExpression="team_name" />
                         <asp:BoundField DataField="team_wins" HeaderText="Number of Round Wins" Visible="true" SortExpression="team_wins" />
                         <asp:BoundField DataField="team_losses" HeaderText="Number of Round Losses" Visible="true" SortExpression="team_losses" />
                        ...
                        <asp:BoundField DataField="team_oponent" HeaderText="Oppenent" Visible="true" SortExpression="team_oponent" />
                         <asp:BoundField DataField="team_oponent_wins" HeaderText="Oppenent Round Wins" Visible="true" SortExpression="team_oponent_wins" />
