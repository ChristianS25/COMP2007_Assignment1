<%@ Page Title="sport2" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Sport2.aspx.cs" Inherits="CR_Assignment1.Sport2" %>

<asp:Content ID="sport2" ContentPlaceHolderID="head" runat="server">
    <!--
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="col-md-2 well">
            <img src="/Assets/fnatic.png" width="150"/>
        </div>

        <div class="col-md-6 col-md-offset-1 well">
             <div class="panel panel-default">
             <!-- Default panel contents -->
             <div class="panel-heading"><a href="Team3.aspx">Fnatic</a> - Members</div>
                <!-- List group -->
                <ul class="list-group">
       ...
       <div class="col-md-2 col-md-offset-1 well">
             <div class="panel panel-default">
             <!-- Default panel contents -->
             <div class="panel-heading">Fnatic Latest Week Scores</div>
                <!-- List group -->                
    ...
    <div class="container">
        <div class="col-md-2 pull-left  well">
            <img src="/Assets/epsilon.png" width="150"/>
        </div>

        <div class="col-md-6 col-md-offset-1 well">
             <div class="panel panel-default">
             <!-- Default panel contents -->
             <div class="panel-heading"><a href="Team4.aspx">Epsilon</a> - Members</div>
                <!-- List group -->
                <ul class="list-group">
       ...
       <div class="col-md-2 col-md-offset-1 well">
             <div class="panel panel-default">
             <!-- Default panel contents -->
             <div class="panel-heading">Epsilon Latest Week Scores</div>
                <!-- List group -->                
               <asp:GridView runat="server" CssClass="table table-bordered table-striped table-hover"
